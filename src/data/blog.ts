...
export const blogPosts: BlogPost[] = [
  {
    ...
    image: 'https://placehold.co/600x400/7A9471/FAF6EE?text=Hair+Oil+Benefits',
    ...
    body: [
      ...
      'One of the principal benefits of botanical oils is deep hydration. Unlike synthetic silicone oils, natural oils like cold-pressed coconut, argan, and castor oils possess fatty acids that penetrate deep into the hair shaft, repairing damage from styling and UV exposure.',
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/C97C5D/FAF6EE?text=Ayurvedic+Clays',
    author: 'Ananya Founder',
    date: 'June 28, 2026',
    body: [
      ...
      'Multani Mitti (Fuller\'s Earth) is renowned for its outstanding oil-absorbing properties, making it the perfect remedy for acne-prone skin. It gently draws out blackheads, sebum, and micro-particles, reducing acne triggers naturally.',
      ...
      'For best results, mix clay face packs with organic rose water, raw honey, or plain yogurt. This customizes the pack for your unique skin needs, leaving it clear, soft, and beautifully glowing.',
    ],
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/5A7453/FAF6EE?text=Serums+Guide',
    author: 'Dr. Shruti Sharma',
    date: 'June 15, 2026',
    body: [
      'Active face serums are the concentrated powerhouses of any skincare routine. Because their molecules are smaller than those of traditional moisturizers, serums penetrate deeper into the skin layers to deliver target ingredients.',
      ...
      'For maximum benefits, layer them! Apply Vitamin C first on clean dry skin, follow with Hyaluronic Acid for deep moisture lock, and finish with a botanical moisturizer to seal the active ingredients in place.',
    ],
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/A8C1A1/2E2A26?text=Rosemary+Oil',
    author: 'Dr. Shruti Sharma',
    date: 'June 02, 2026',
    body: [
      'Rosemary (Rosmarinus Officinalis) has taken the beauty community by storm. While it feels like a modern trend, rosemary has been utilized in hair washes for centuries across Mediterranean cultures to combat thinning.',
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/F0E8D6/2E2A26?text=Weekend+Rituals',
    author: 'Ananya Founder',
    date: 'May 20, 2026',
    body: [
      'Self-care is not about quick fixes; it is a ritual of slowing down. Weekend beauty rituals allow you to reconnect with your body and mind, using natural ingredients to restore skin and hair balance.',
      'Start your ritual by clearing your space and lighting a natural beeswax candle. Warm some botanical hair oil between your palms and massage it slowly into your scalp, leaving it to deeply condition your locks.',
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/7A9471/FAF6EE?text=Morning+Glow',
    author: 'Ananya Founder',
    date: 'May 05, 2026',
    body: [
      'A morning routine is all about defense and protection. During the day, your skin is exposed to UV rays, pollution, and climate shifts. Our simple 4-step routine is designed to prepare your skin barrier for the day.',
      ...
      'Step 3 is applying a concentrated Vitamin C and Hyaluronic Acid serum to brighten and plump. Step 4 is sealing everything with a lightweight moisturizer, followed by SPF protection.',
    ],
  },
];
